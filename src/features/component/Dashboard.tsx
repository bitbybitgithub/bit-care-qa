...
import { fetchDashboardStats } from "../../api/dashboardApi"; // import API
...
const Dashboard = () => {
  ...
  const getStats = async () => {
    ...
    setError("");
    try {
      const data = await fetchDashboardStats(101); // use API function
      setStats(data);
    } catch {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans relative p-3 md:p-6">
