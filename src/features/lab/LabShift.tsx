...
//   // ⭐ AUTO ADD SHIFT WHEN TOGGLE IS TURNED ON
//   useEffect(() => {
//     if (opShift.is_active && shifts.length === 0) {
//       setShifts([{ start: "", end: "", error: null }]);
//     }

//     if (!opShift.is_active) {
//       setShifts([]);
//     }
//   }, [opShift.is_active]);
...
//           <Switch
//             checked={!expanded} // use local expanded state here
//             onChange={(e) => {
//               const newVal = !e.target.checked; // true = expanded on toggle off false (holiday)
//               setExpanded(newVal);               // update local
//               handleOperationDay(opShift.lab_opt_id, opShift.clinic_id, newVal); // notify parent
//             }}
//           />
//         </div>
//       </div>
